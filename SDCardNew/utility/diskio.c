...
#include <in430.h>
#include "Energia.h"
#include "diskio.h"          // FatFs standard header
#include "FatFs2Jaffl.h"     // Functions that Jaffl attaches the SPI stuff to
#include "ff.h"
...
/*-----------------------------------------------------------------------*/
/* Attach the CS pin high/low functions from jaffl.cpp                   */
